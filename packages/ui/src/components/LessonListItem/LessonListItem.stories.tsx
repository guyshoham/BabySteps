...
// The meta decorator already wraps each story in <ol className="bs-lesson-list">.
// Story decorators add to it, they do not replace it, so render only the items here.
